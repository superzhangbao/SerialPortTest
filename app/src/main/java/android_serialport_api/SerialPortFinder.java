...
public class SerialPortFinder {
    ...
    private static final String[] DATA_BITS = new String[]{"5","6","7","8"};
    private static final String[] STOP_BITS = new String[]{"1","1.5","2"};
    private static final String[] PARITY_BITS = new String[]{"N","O","E"};
